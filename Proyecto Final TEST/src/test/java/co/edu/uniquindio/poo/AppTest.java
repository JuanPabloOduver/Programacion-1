...
public class AppTest {
    ...
    public void testAccionesVehiculo() {
        ...
        AccionesVehiculo acciones = new AccionesVehiculo(vehiculo, empleado, cliente);
    ...
    public void concesionarioTest(){
        ...
        concesionario.registrarEmpleado(empleado);
        Tramite compra = new Tramite( vehiculo, empleado, cliente);
        ...
        Tramite alquiler = new Tramite( vehiculo, empleado, cliente);
        ...
        Tramite venta = new Tramite( vehiculo, empleado, cliente);
